        ...
        LazyColumn(
            ...
            items(list.value) { item ->
                ...
                Card(modifier = Modifier.padding(10.dp),
                    ...
                    Text(text ="Kitap Adı:"+ item.bookName, fontSize = 12.sp)
                    Text(text ="Kitap Yazarı:"+ item.bookWriter, fontSize = 12.sp)
                    Text(text = "Okuyan:"+item.PersonId, fontSize = 12.sp, fontStyle = FontStyle.Italic)
                    }
                }
